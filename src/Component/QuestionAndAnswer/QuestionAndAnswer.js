    ...
    return (
        <div className='question-and-answer'>
            ...
            <div className='answer'>
                ...
                <p>Accepts a function that contains imperative possibly effectful code. Mutations, subscriptions, timers, logging, and other side effects are not allowed inside the main body of a function component. useEffect runs on every render. That means that when the count changes, a render happens, which then triggers another effect.
                </p>
